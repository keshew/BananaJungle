...
struct ZombieJackpotView: View {
    @StateObject var viewModel =  ZombieJackpotViewModel()
        ...
        ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 23) {
                        ZStack(alignment: .bottom) {
                            ...
                            Rectangle()
                                .fill(Color(red: 27/255, green: 0/255, blue: 54/255).opacity(0.6))
                                .overlay {
                                    RoundedRectangle(cornerRadius: 12)
                                        ...
                                        .overlay {
                                            Text("WIN: \(viewModel.win)")
                                                ...
                                                .foregroundStyle(Color(red: 85/255, green: 216/255, blue: 28/255))
                                                .offset(y: 2)
                                        }
                                }
                                                ...
                                                HStack(spacing: 10) {
                                                    ForEach(0..<5, id: \.self) { col in
                                                        Image(viewModel.slots[row][col])
                                                            ...
                                                            .padding(.vertical, 8)
                                                            .background(viewModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? .purple : Color.black.opacity(0.3))
                                                            .cornerRadius(10)
                                                    }
                                                }
                                            }
            ...
            if viewModel.win >= 2000 {
                ...
                VStack {
                    ...
                    Rectangle()
                        .fill(Color(red: 85/255, green: 216/255, blue: 28/255).opacity(0.2))
