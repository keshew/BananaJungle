...
class ZombieJackpotViewModel: ObservableObject {
    let contact = ZombieJackpotModel()
    @Published var coin = UserDefaultsManager.shared.coins
    @Published var bet: Int = 50
    @Published var slots: [[String]] = []
    let allFruits = ["zom1", "zom2", "zom3","zom4", "zom5", "zom6"]
    ...
    let symbolArray = [
        Symbol(image: "zom1", value: "1000"),
        Symbol(image: "zom2", value: "500"),
        Symbol(image: "zom3", value: "100"),
        Symbol(image: "zom4", value: "50"),
        Symbol(image: "zom5", value: "10"),
        Symbol(image: "zom6", value: "5")
    ]
