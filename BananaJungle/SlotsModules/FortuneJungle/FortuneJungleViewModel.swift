...
class FortuneJungleViewModel: ObservableObject {
    let contact = FortuneJungleModel()
    ...
    let symbolArray = [
        Symbol(image: "jun1", value: "1000"),
        Symbol(image: "jun2", value: "500"),
        Symbol(image: "jun3", value: "100"),
        Symbol(image: "jun4", value: "50"),
        Symbol(image: "jun5", value: "10"),
        Symbol(image: "jun6", value: "5")
    ]
