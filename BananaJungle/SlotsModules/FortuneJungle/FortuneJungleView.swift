...
struct FortuneJungleView: View {
    @StateObject var viewModel =  FortuneJungleViewModel()
                                                ...
                                                HStack(spacing: 10) {
                                                    ForEach(0..<5, id: \.self) { col in
                                                        Image(viewModel.slots[row][col])
                                                            ...
                                                            .padding(.vertical, 8)
                                                            .background(viewModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? .green : Color.black.opacity(0.3))
                                                            .cornerRadius(10)
                                                    }
                                                }
                                            }
